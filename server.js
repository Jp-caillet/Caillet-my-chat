...
io.on('connection', (socket) => {
  ...
  /**
    * bot qui fait appel à l'API hearstone pour comparer 2 carte entre elle
    * @param {message | object} 
    */
  const botcombat = (message) =>{
  ...
  /**
    * bot qui fait appel à l'API hearstone pour afficher l'image d'une carte
    * @param {message | object} 
    */
  const bothearstonne = (message) =>{
  ...
  /**
    * bot qui fait appel à l'API uber pour faire un voyage d'apres la localisation de l'user
    * @param {message | object} 
    */

  const botubeur = (message)=>{
  ...
  /**
    * bot qui fait appel à l'API carefour pour localiser les magasin proche de l'utilisateur
    * @param {message | object} 
    */

  const botcarefour = (message)=>{
  ...
  /**
    * bot qui fait appel à l'API youtube pour rechercher des videos
    * @param {message | object} 
    */

  const botyoutuber = (message)=>{
  ...
  /**
    * renvoie les commandes du chatbot
    * @param {message | object} 
    */

  const helpeur = (message)=>{
    const helper = [
